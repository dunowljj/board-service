 ...
 * {@code INTERNAL_ERROR} (which is reserved for the safety-net handler in
 * {@code GlobalExceptionHandler}; see ADR-0005 §1, §2).
 * <p>
 ...
 * caught by the safety-net handler, which alone is allowed to emit
